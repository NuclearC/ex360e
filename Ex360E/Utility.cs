 ...
 * 
 * a.bertolotto - 2012/12/02 19.07.05 - Refactoring to support PE and PE+ file formats
...
namespace StrongNameRemove
{
    internal class Utility
    {
        ...
        /// <summary>
        /// Column index in Assembly Table for Flags - see CLI Reference Partition II - § 22.2
        ...
        /// </summary>
        private const int ASSEMBLY_TABLE_FLAGS_COLUMN_INDEX = 5;
        ...
        public static bool PatchAssemblyStrongSigning(string fileName, uint cliHeaderFlag, long cliHeaderFlagOffset, long strongNameSignatureOffset,
                                                      long publicKeyIndexOffset, uint assemblyFlag, long assemblyFlagOffset, int blobIndexSize)
        {
            bool returnValue;
        ...
        {
            return ((cliHeaderFlag & COMIMAGE_FLAGS_VALUE_STRONGNAMESIGNED) == COMIMAGE_FLAGS_VALUE_STRONGNAMESIGNED);
        }
